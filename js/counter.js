    ...
    push: function(_19) {
        if (_19 !== null && typeof _19 === "object") {
            ...
            if (_1d(_19, "name") && isValidEventName(_19.name)) {
                ...
                var _22 = 3;
                var _23 = sc_click_dir + "click.gif?sc_project=" + clickstat_project + "&security=" + clickstat_security + "&m=" + _22 + "&u=" + sc_url + "&t=" + sc_title + "&en=" + _20 + "&sess=1763af&rand=" + Math.random() + _21 + sc_uuid_q + sc_unique_returning;
                var _24 = new Image();
                _24.onload = sc_none;
                _24.src = _23;
                sc_delay()
...
(function(_25, _26, _27, _28) {
    ...
    function classify_referrer(r) {
        ...
        var _36 = ["utm_source=bing", "?gclid=", "&gclid=", "utm_medium=cpc", "utm_medium=paid-media", "utm_medium=ppc"];
    ...
    try {
        ...
        function ARC4(key) {
            var t, _50 = key.length, me = this, i = 0, j = me.i = me.j = 0, s = me.S = [];
            if (!_50) {
                key = [_50++]
            }
            while (i < _26) {
        ...
        function generate_uuid() {
            ...
            _45(_8a);
            var _8b = "0123456789ABCDEF".split(""), _8c = new Array(_88), rnd = 0, r;
            for (var i = 0; i < _88; i++) {
    ...
    var _b7 = sc_unique_returning + "&resolution=" + sc_width + "&h=" + sc_height + "&camefrom=" + escape(sc_referer.substring(0, 600)) + "&u=" + sc_url + "&t=" + sc_title + _29 + "&sc_snum=" + sc_script_num + sc_pageview_tag_string + "&sess=1763af";
...
if (sc_cls > 0) {
    if (clickstat_done != 1) {
            ...
            if (_d4) {
                ...
                if (_d6 != 0) {
                    ...
                    if (_d7.length > 0) {
                        ...
                        var _d8 = _d5 + "click.gif?sc_project=" + clickstat_project + "&security=" + clickstat_security + "&c=" + _d7 + "&m=" + _d6 + "&u=" + sc_url + "&t=" + sc_title + "&sess=1763af&rand=" + Math.random() + sc_uuid_q + sc_unique_returning;
                        var _d9 = new Image();
                        _d9.onload = sc_none;
                        _d9.src = _d8;
                        sc_delay()
        ...
        function sc_adsense_click(_da) {
            ...
            var i = new Image();
            var _dd = sc_click_dir + "click.gif?sc_project=" + clickstat_project + "&security=" + clickstat_security + "&c=" + _db + "&m=2&u=" + sc_url + "&t=" + sc_title + "&sess=1763af&rand=" + Math.random() + sc_uuid_q + sc_unique_returning;
            i.src = _dd;
            sc_delay()
        }
